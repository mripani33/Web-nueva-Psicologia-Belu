// app-firebase.js - VERSIÓN ACTUALIZADA CON HERO FUNCIONANDO
...
function loadHero() {
    ...
    // Botón principal
    const btnPrimary = document.querySelector('.btn-hero-primary');
    if (btnPrimary && hero.btnPrimary) {
        btnPrimary.textContent = hero.btnPrimary;
        console.log('✅ Hero button 1 updated:', hero.btnPrimary);
    }
    
    // Botón secundario
    const btnSecondary = document.querySelector('.btn-hero-secondary');
    if (btnSecondary && hero.btnSecondary) {
        btnSecondary.textContent = hero.btnSecondary;
        console.log('✅ Hero button 2 updated:', hero.btnSecondary);
    }
...
function loadAbout() {
    ...
    // Biografía - buscar por diferentes posibles clases
